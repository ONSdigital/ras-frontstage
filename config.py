...
class Config(object):
    ...
    RM_COLLECTION_EXERCISE_SERVICE = f'{RM_COLLECTION_EXERCISE_SERVICE_PROTOCOL}://{RM_COLLECTION_EXERCISE_SERVICE_HOST}:{RM_COLLECTION_EXERCISE_SERVICE_PORT}'
    ...
    RAS_COLLECTION_INSTRUMENT_SERVICE = f'{RAS_COLLECTION_INSTRUMENT_SERVICE_PROTOCOL}://{RAS_COLLECTION_INSTRUMENT_SERVICE_HOST}:{RAS_COLLECTION_INSTRUMENT_SERVICE_PORT}'
    ...
    RAS_FRONTSTAGE_API_SERVICE = f'{RAS_FRONTSTAGE_API_PROTOCOL}://{RAS_FRONTSTAGE_API_HOST}:{RAS_FRONTSTAGE_API_PORT}/'
    ...
    RAS_SECURE_MESSAGING_SERVICE = f'{RAS_SECURE_MESSAGE_SERVICE_PROTOCOL}://{RAS_SECURE_MESSAGE_SERVICE_HOST}:{RAS_SECURE_MESSAGE_SERVICE_PORT}/'
