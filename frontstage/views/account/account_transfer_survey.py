...
from frontstage.models import AccountSurveySelectBusinessForm, AccountSurveyShareRecipientEmailForm, \
...
def transfer_survey_business_select(session):
    ...
    return render_template('surveys/surveys-transfer/business-select.html',
...
def transfer_survey_survey_select(session):
    ...
    return render_template('surveys/surveys-transfer/survey-select.html',
...
def set_surveys_selected_list(selected_businesses, form):
    ...
    flask_session['transfer_surveys_selected_list'] = [item for sublist in transfer_surveys_selected_list for item in sublist]
...
def transfer_survey_email_entry(session):
    ...
    return render_template('surveys/surveys-transfer/recipient-email-address.html',
