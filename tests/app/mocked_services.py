...
with open('tests/test_data/party/business_party_no_trading_as.json') as json_data:
    business_party_no_trading_as = json.load(json_data)
...
with open('tests/test_data/collection_exercise/go_live_event.json') as json_data:
    collection_exercise_go_live_event = json.load(json_data)

with open('tests/test_data/collection_exercise/go_live_event_before.json') as json_data:
    collection_exercise_go_live_event_before = json.load(json_data)
