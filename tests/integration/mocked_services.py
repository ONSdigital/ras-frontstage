...
url_resend_expired_account_change_verification = f"{app.config['PARTY_URL']}/party-api/v1/resend-account-email-change" \
...
url_respondent_party_by_id = f'{app.config["PARTY_URL"]}/party-api/v1/respondents/id/{party["id"]}'
