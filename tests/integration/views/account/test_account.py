...
class TestSurveyList(unittest.TestCase):
    ...
    def test_account_contact_details_success(
        self, mock_request, get_respondent_enabled_enrolments, get_survey_list, _, get_respondent_party_by_id
    ):
        mock_request.get(url_banner_api, status_code=404)
        get_respondent_party_by_id.return_value = respondent_party
    ...
    def test_create_message_post_success(
        self, mock_request, send_message, get_survey, get_survey_list, get_respondent_enabled_enrolments
    ):
        mock_request.get(url_banner_api, status_code=404)
