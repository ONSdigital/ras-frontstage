...
from frontstage.views.account.account import create_success_message, check_attribute_change
...
class TestAccount(unittest.TestCase):
    ...
    def test_check_attribute_change_returns_true(self):
        ...
        update_required_flag = check_attribute_change(form, attributes_changed, respondent_details,
